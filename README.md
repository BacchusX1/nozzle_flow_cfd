 ...
 -- CURRENTLY GEOMETRIES CAN BE DRAWN - MESHING CAN BE EXECUTED - AND FIRST OPENFOAM SIMULATIONS ARE DONE --

 Next Steps:
    - check simulation results (almost done)
    - implement postprocessing via script
    - migrate to GUI
...
![Dashboard Screenshot](screenshots/geometry.png)

*GUI with pre-loaded laval nozzle as geometry*

![Dashboard Screenshot](screenshots/mesh.png)

*Auto-Meshed nozzle from geomtry*
