...
class TemplateLoader:
    ...
    def __init__(self, templates_dir: Optional[str] = None):
        if templates_dir is None:
            ...
            # Go up from src/backend/drawing to project root, then down to geometry/templates
    ...
    def create_geometry_from_template(self, template_name: str):
        ...
        from backend.drawing.geometry import PolynomialElement, LineElement, ArcElement
